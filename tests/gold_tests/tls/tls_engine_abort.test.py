...
tr.Processes.Default.Command = "{0} {1} 30".format(sys.executable, abort_client)
tr.ReturnCode = 0
...
# The server process must not have reported an AddressSanitizer error.
ts.Disk.diags_log.Content = Testers.ExcludesExpression("AddressSanitizer", "No ASan error in the server")
